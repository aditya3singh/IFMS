...
public class AuthController : ControllerBase
{
    ...
    /// <summary>Admin only — force-set a user's password (bypasses current-password check).</summary>
    [HttpPut("users/{id:guid}/set-password")]
    [Authorize(Roles = "Admin")]
    public async Task<IActionResult> AdminSetPassword(Guid id, [FromBody] AdminSetPasswordRequest request)
    {
        ...
        return Ok(new { message = "Password updated.", userId = id });
    }
